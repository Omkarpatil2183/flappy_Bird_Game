...
class Game:
    ...
    def connect_to_db(self):
        ...
        self.client = MongoClient("mongodb+srv://abhiganji03:RRNO321973@cluster0.w3e1por.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
        self.db = self.client["flappy_bird"]
